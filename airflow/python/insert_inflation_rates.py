...
# Nom de la table
table_inflation = 'inflation_rates'

# Connexion à la base de données
conn = psycopg2.connect(**db_config)
cursor = conn.cursor()

# ---------------- Création de la table inflation_rates ---------------
create_table_query = f"""
CREATE TABLE IF NOT EXISTS {table_inflation} (
    Date DATE,
    USA FLOAT,
    Japon FLOAT,
    France FLOAT,
...
clear_table_query = f"TRUNCATE TABLE {table_inflation};"
...
with open(csv_file_path, 'r') as f:
    ...
    insert_query = f"INSERT INTO {table_inflation} (Date, USA, Japon, France, Europe) VALUES (%s, %s, %s, %s, %s)"
